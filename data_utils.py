...
if __name__ == '__main__':
    data = Data()
##    E = np.eye(4) img = np.zeros((4, 15)) idxs = data.strToIndexs('aghgbccdahbaml') print idxs
...
##    for i in range(3):
##        data.shuffleData() batch_x, batch_y = data.getBatchToIndices() print batch_x[0], batch_y[0]
